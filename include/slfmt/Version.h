...
constexpr long SLFMT_VERSION_MAJOR = 0;
constexpr long SLFMT_VERSION_MINOR = 1;
constexpr long SLFMT_VERSION_PATCH = 0;

constexpr long SLFMT_VERSION = SLFMT_VERSION_MAJOR * 10000 + SLFMT_VERSION_MINOR * 100 + SLFMT_VERSION_PATCH;
